...
class UserStories(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogram.raw.base.stories.UserStories`.
    ...
    __slots__: List[str] = ["stories", "users"]

    ID = 0x37a6ff5f
    QUALNAME = "types.stories.UserStories"

    def __init__(self, *, stories: "raw.base.UserStories", users: List["raw.base.User"]) -> None:
        self.stories = stories  # UserStories
    ...
    def read(b: BytesIO, *args: Any) -> "UserStories":
        ...
        return UserStories(stories=stories, users=users)
