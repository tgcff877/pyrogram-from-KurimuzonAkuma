...
class Message(Object, Update):
    ...
    Parameters:
        ...
        approve_join_requst (``bool``, *optional*):
            Service message: approve user join request
    ...
    def __init__(
        ...
        *,
        ...
        approve_join_request: bool = None,
        ...
        self.approve_join_request = approve_join_request
    ...
    async def _parse(
        ...
        if isinstance(message, raw.types.MessageService):
            ...
            if isinstance(action, raw.types.MessageActionChatAddUser):
                ...
                service_type = enums.MessageServiceType.APPROVE_USER_REQUEST
